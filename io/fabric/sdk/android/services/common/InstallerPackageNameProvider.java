...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new C14481();

    class C14481 implements ValueLoader<String> {
        C14481() {
        }
    ...
    public String getInstallerPackageName(Context appContext) {
        try {
            ...
            Fabric.getLogger().mo3813e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
