...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C14511();
    ...
    private final WorkerRunnable<Params, Result> worker = new C14522();

    static class C14511 implements ThreadFactory {
    ...
    class C14522 extends WorkerRunnable<Params, Result> {
        C14522() {
            super();
        }
