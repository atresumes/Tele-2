...
public class PendingRow implements Row {
    ...
    private RealmChangeListener<PendingRow> listener = new C14961();
    ...
    class C14961 implements RealmChangeListener<PendingRow> {
        C14961() {
        }
    ...
    public PendingRow(SharedRealm sharedRealm, TableQuery query, SortDescriptor sortDescriptor, boolean returnCheckedRow) {
