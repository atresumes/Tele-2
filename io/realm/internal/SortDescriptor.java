...
public class SortDescriptor {
    ...
    private static SortDescriptor getInstance(SchemaProxy proxy, Table table, String[] fieldDescriptions, Sort[] sortOrders, Set<RealmFieldType> legalInternalTypes, Set<RealmFieldType> legalTerminalTypes, String message) {
