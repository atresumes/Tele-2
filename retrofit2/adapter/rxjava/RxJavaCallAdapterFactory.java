...
public final class RxJavaCallAdapterFactory extends Factory {
    ...
    static final class ResultCallAdapter implements CallAdapter<Observable<?>> {
        ...
        class C16691 implements Func1<Throwable, Result<R>> {
            C16691() {
            }
        ...
        class C16702 implements Func1<Response<R>, Result<R>> {
            C16702() {
            }
        ...
        public <R> Observable<Result<R>> adapt(Call<R> call) {
            Observable<Result<R>> observable = Observable.create(new CallOnSubscribe(call)).map(new C16702()).onErrorReturn(new C16691());
            if (this.scheduler != null) {
                return observable.subscribeOn(this.scheduler);
            }
            return observable;
