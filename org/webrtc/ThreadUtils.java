        ...
        handler.post(new Runnable() {
            public void run() {
                try {
                    ...
                    caughtException.f231e = e;
                }
                barrier.countDown();
            }
        });
        awaitUninterruptibly(barrier);
        if (caughtException.f231e == null) {
            return result.value;
        }
        RuntimeException runtimeException = new RuntimeException(caughtException.f231e);
        runtimeException.setStackTrace(concatStackTraces(caughtException.f231e.getStackTrace(), runtimeException.getStackTrace()));
