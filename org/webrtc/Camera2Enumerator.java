...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m173e(TAG, "Camera access exception: " + e);
            return new String[0];
        }
    }
        ...
        synchronized (cachedSupportedFormats) {
            ...
            try {
                ...
                for (Size size : sizes) {
                    ...
                    Logging.m172d(TAG, "Format: " + size.width + "x" + size.height + "@" + maxFps);
                }
                cachedSupportedFormats.put(cameraId, formatList);
                long endTimeMs = SystemClock.elapsedRealtime();
                Logging.m172d(TAG, "Get supported formats for camera index " + cameraId + " done." + " Time spent: " + (endTimeMs - startTimeMs) + " ms.");
                return formatList;
            } catch (Exception ex) {
                Logging.m173e(TAG, "getCameraCharacteristics(): " + ex);
