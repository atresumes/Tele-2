...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private final TimerTask tickTask = new C16221();
    private final Timer timer = new Timer();
    private final VideoReader videoReader;

    class C16221 extends TimerTask {
        C16221() {
        }
    ...
    private static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String file) throws IOException {
            ...
            Logging.m172d(TAG, "Color space: " + colorSpace);
            if (!colorSpace.equals("420") && !colorSpace.equals("420mpeg2")) {
                ...
                Logging.m172d(TAG, "frame dim: (" + w + ", " + h + ") frameSize: " + this.frameSize);
            }
        }
        ...
        public void close() {
            try {
                ...
                Logging.m174e(TAG, "Problem closing file", e);
            }
        }
    }
    ...
    public FileVideoCapturer(String inputFile) throws IOException {
        try {
            ...
            Logging.m172d(TAG, "Could not open video file: " + inputFile);
            throw e;
        }
    }
