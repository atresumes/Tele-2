...
public class PeerConnectionFactory {
    ...
    public void setVideoHwAccelerationOptions(Context localEglContext, Context remoteEglContext) {
        if (this.localEglbase != null) {
            Logging.m176w(TAG, "Egl context already set.");
    ...
    private static void onNetworkThreadReady() {
        ...
        Logging.m172d(TAG, "onNetworkThreadReady");
    }

    private static void onWorkerThreadReady() {
        workerThread = Thread.currentThread();
        Logging.m172d(TAG, "onWorkerThreadReady");
    }

    private static void onSignalingThreadReady() {
        signalingThread = Thread.currentThread();
        Logging.m172d(TAG, "onSignalingThreadReady");
    }
}
