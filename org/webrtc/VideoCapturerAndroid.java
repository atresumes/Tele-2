...
public class VideoCapturerAndroid implements CameraVideoCapturer, PreviewCallback, OnTextureFrameAvailableListener {
    ...
    private final ErrorCallback cameraErrorCallback = new C16451();
    ...
    class C16451 implements ErrorCallback {
        C16451() {
        }
        ...
        public void onError(int error, Camera camera) {
            ...
            Logging.m173e(VideoCapturerAndroid.TAG, errorMessage);
    ...
    public static VideoCapturerAndroid create(String name, CameraEventsHandler eventsHandler, boolean captureToTexture) {
        try {
            ...
            Logging.m174e(TAG, "Couldn't create camera.", e);
            return null;
        }
    }
    ...
    public void printStackTrace() {
        ...
        if (cameraThread != null) {
            ...
            if (cameraStackTraces.length > 0) {
                Logging.m172d(TAG, "VideoCapturerAndroid stacks trace:");
    ...
    public void switchCamera(final org.webrtc.CameraVideoCapturer.CameraSwitchHandler r5) {
        /*
        r4 = this;
    ...
    L_0x0016:
        ...
        org.webrtc.Logging.m176w(r1, r3);	 Catch:{ all -> 0x0026 }
    ...
    public VideoCapturerAndroid(String cameraName, CameraEventsHandler eventsHandler, boolean captureToTexture) {
        ...
        Logging.m172d(TAG, "VideoCapturerAndroid isCapturingToTexture : " + this.isCapturingToTexture);
    }

    private void checkIsOnCameraThread() {
        if (this.cameraThreadHandler == null) {
            Logging.m173e(TAG, "Camera is not initialized - can't check thread.");
    ...
    public void startCapture(final int width, final int height, final int framerate) {
        Logging.m172d(TAG, "startCapture requested: " + width + "x" + height + "@" + framerate);
        if (!isInitialized()) {
            ...
            Logging.m173e(TAG, "Camera has already been started.");
        } else if (!maybePostOnCameraThread(new Runnable() {
            public void run() {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void startCaptureOnCameraThread(final int r8, final int r9, final int r10) {
        /*
        r7 = this;
        r6 = 1;
        r5 = 0;
    ...
    L_0x0013:
        ...
        org.webrtc.Logging.m173e(r1, r2);
    L_0x001a:
        return;
    L_0x001b:
        r1 = r7.camera;
    ...
    L_0x0027:
        ...
        org.webrtc.Logging.m172d(r1, r3);	 Catch:{ all -> 0x00e4 }
    ...
    L_0x0055:
        ...
        org.webrtc.Logging.m172d(r1, r2);	 Catch:{ IOException -> 0x00c7, RuntimeException -> 0x0106 }
        r1 = r7.camera;	 Catch:{ IOException -> 0x00c7, RuntimeException -> 0x0106 }
    ...
    L_0x00c8:
        ...
        org.webrtc.Logging.m174e(r1, r2, r0);
    ...
    L_0x00f3:
        ...
        org.webrtc.Logging.m174e(r1, r2, r0);	 Catch:{ IOException -> 0x00c7, RuntimeException -> 0x0106 }
        ...
        r2.<init>(r8, r9, r10);	 Catch:{ IOException -> 0x00c7, RuntimeException -> 0x0106 }
    ...
    private void startPreviewOnCameraThread(int width, int height, int framerate) {
        ...
        if (!this.isCameraRunning.get() || this.camera == null) {
            Logging.m173e(TAG, "startPreviewOnCameraThread: Camera is stopped");
            return;
        }
        Logging.m172d(TAG, "startPreviewOnCameraThread requested: " + width + "x" + height + "@" + framerate);
        ...
        Logging.m172d(TAG, "Available fps ranges: " + supportedFramerates);
        ...
        Logging.m172d(TAG, "Available preview sizes: " + supportedPreviewSizes);
        CaptureFormat captureFormat = new CaptureFormat(previewSize.width, previewSize.height, fpsRange);
        if (!captureFormat.equals(this.captureFormat)) {
            Logging.m172d(TAG, "isVideoStabilizationSupported: " + parameters.isVideoStabilizationSupported());
            ...
            if (parameters.getSupportedFocusModes().contains("continuous-video")) {
                Logging.m172d(TAG, "Enable continuous auto focus mode.");
                parameters.setFocusMode("continuous-video");
            }
            Logging.m172d(TAG, "Start capturing: " + captureFormat);
    ...
    public void stopCapture() throws InterruptedException {
        ...
        if (maybePostOnCameraThread(new Runnable() {
            ...
            if (!barrier.await(7000, TimeUnit.MILLISECONDS)) {
                Logging.m173e(TAG, "Camera stop timeout");
                printStackTrace();
                if (this.eventsHandler != null) {
            ...
            Logging.m172d(TAG, "stopCapture done");
            return;
        }
        Logging.m173e(TAG, "Calling stopCapture() for already stopped camera.");
    }

    private void stopCaptureOnCameraThread(boolean stopHandler) {
        checkIsOnCameraThread();
        Logging.m172d(TAG, "stopCaptureOnCameraThread");
        ...
        Logging.m172d(TAG, "Stop preview.");
        if (this.camera != null) {
            this.camera.stopPreview();
            this.camera.setPreviewCallbackWithBuffer(null);
        }
        ...
        Logging.m172d(TAG, "Release camera.");
        if (this.camera != null) {
            this.camera.release();
            this.camera = null;
        }
        ...
        Logging.m172d(TAG, "stopCaptureOnCameraThread done");
    }

    private void switchCameraOnCameraThread() {
        checkIsOnCameraThread();
        if (this.isCameraRunning.get()) {
            Logging.m172d(TAG, "switchCameraOnCameraThread");
            ...
            Logging.m172d(TAG, "switchCameraOnCameraThread done");
            return;
        }
        Logging.m173e(TAG, "switchCameraOnCameraThread: Camera is stopped");
    }
    ...
    public void onPreviewFrame(byte[] data, Camera callbackCamera) {
        checkIsOnCameraThread();
        if (!this.isCameraRunning.get()) {
            Logging.m173e(TAG, "onPreviewFrame: Camera is stopped");
    ...
    public void onTextureFrameAvailable(int oesTextureId, float[] transformMatrix, long timestampNs) {
        ...
        Logging.m173e(TAG, "onTextureFrameAvailable: Camera is stopped");
