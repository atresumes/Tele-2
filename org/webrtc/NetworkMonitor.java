...
public class NetworkMonitor {
    ...
    class C16261 implements Observer {
        C16261() {
        }
    ...
    private void startMonitoring(long nativeObserver) {
        Logging.m172d(TAG, "Start monitoring from native observer " + nativeObserver);
    ...
    private void stopMonitoring(long nativeObserver) {
        Logging.m172d(TAG, "Stop monitoring from native observer " + nativeObserver);
    ...
    private void setAutoDetectConnectivityStateInternal(boolean shouldAutoDetect) {
        if (!shouldAutoDetect) {
            ...
            this.autoDetector = new NetworkMonitorAutoDetect(new C16261(), this.applicationContext);
