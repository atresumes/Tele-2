...
public class ScreenCapturerAndroid implements VideoCapturer, OnTextureFrameAvailableListener {
    ...
    class C16302 implements Runnable {
        C16302() {
        }
    ...
    public synchronized void stopCapture() {
        checkNotDisposed();
        ThreadUtils.invokeAtFrontUninterruptibly(this.surfaceTextureHelper.getHandler(), new C16291());
    }
    ...
    public synchronized void changeCaptureFormat(int width, int height, int ignoredFramerate) {
        ...
        if (this.virtualDisplay != null) {
            ThreadUtils.invokeAtFrontUninterruptibly(this.surfaceTextureHelper.getHandler(), new C16302());
        }
    }
