...
public interface CameraVideoCapturer extends VideoCapturer {
    ...
    public static class CameraStatistics {
        ...
        private final Runnable cameraObserver = new C16141();
        ...
        class C16141 implements Runnable {
            ...
            public void run() {
                Logging.m172d(CameraStatistics.TAG, "Camera fps: " + Math.round((((float) CameraStatistics.this.frameCount) * 1000.0f) / 2000.0f) + ".");
                if (CameraStatistics.this.frameCount == 0) {
                    ...
                    if (CameraStatistics.this.freezePeriodCount * 2000 >= CameraStatistics.CAMERA_FREEZE_REPORT_TIMOUT_MS && CameraStatistics.this.eventsHandler != null) {
                        Logging.m173e(CameraStatistics.TAG, "Camera freezed.");
