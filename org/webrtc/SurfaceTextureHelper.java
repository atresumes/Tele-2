...
class SurfaceTextureHelper {
    ...
    class C16322 implements Runnable {
        C16322() {
        }

        public void run() {
            Logging.m172d(SurfaceTextureHelper.TAG, "Setting listener to " + SurfaceTextureHelper.this.pendingListener);
    ...
    class C16333 implements OnFrameAvailableListener {
        C16333() {
        }
    ...
    class C16355 implements Runnable {
        C16355() {
        }
    ...
    class C16366 implements Runnable {
        C16366() {
        }
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() {
            public SurfaceTextureHelper call() {
                try {
                    ...
                    Logging.m174e(SurfaceTextureHelper.TAG, threadName + " create failure", e);
                    return null;
                }
            }
        });
    ...
    private SurfaceTextureHelper(Context sharedContext, Handler handler) {
        ...
        this.setListenerRunnable = new C16322();
        ...
        try {
            ...
            this.surfaceTexture.setOnFrameAvailableListener(new C16333());
        } catch (RuntimeException e) {
    ...
    public void stopListening() {
        Logging.m172d(TAG, "stopListening()");
        this.handler.removeCallbacks(this.setListenerRunnable);
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new C16344());
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new C16366());
    }
