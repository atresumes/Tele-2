...
public class Logging {
    ...
    public static void m172d(String tag, String message) {
        log(Severity.LS_INFO, tag, message);
    }

    public static void m173e(String tag, String message) {
        log(Severity.LS_ERROR, tag, message);
    }

    public static void m176w(String tag, String message) {
        log(Severity.LS_WARNING, tag, message);
    }

    public static void m174e(String tag, String message, Throwable e) {
        log(Severity.LS_ERROR, tag, message);
        log(Severity.LS_ERROR, tag, e.toString());
        log(Severity.LS_ERROR, tag, getStackTraceString(e));
    }

    public static void m177w(String tag, String message, Throwable e) {
        log(Severity.LS_WARNING, tag, message);
        log(Severity.LS_WARNING, tag, e.toString());
        log(Severity.LS_WARNING, tag, getStackTraceString(e));
    }

    public static void m175v(String tag, String message) {
