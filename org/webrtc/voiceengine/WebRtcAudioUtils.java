...
public final class WebRtcAudioUtils {
    ...
    public static synchronized void setWebRtcBasedAutomaticGainControl(boolean enable) {
        synchronized (WebRtcAudioUtils.class) {
            Logging.m176w(TAG, "setWebRtcBasedAutomaticGainControl() is deprecated");
        }
    }
    ...
    public static synchronized boolean useWebRtcBasedAcousticEchoCanceler() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedAcousticEchoCanceler) {
                Logging.m176w(TAG, "Overriding default behavior; now using WebRTC AEC!");
            }
    ...
    public static synchronized boolean useWebRtcBasedNoiseSuppressor() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedNoiseSuppressor) {
                Logging.m176w(TAG, "Overriding default behavior; now using WebRTC NS!");
            }
    ...
    public static void logDeviceInfo(String tag) {
        Logging.m172d(tag, "Android SDK: " + VERSION.SDK_INT + ", " + "Release: " + VERSION.RELEASE + ", " + "Brand: " + Build.BRAND + ", " + "Device: " + Build.DEVICE + ", " + "Id: " + Build.ID + ", " + "Hardware: " + Build.HARDWARE + ", " + "Manufacturer: " + Build.MANUFACTURER + ", " + "Model: " + Build.MODEL + ", " + "Product: " + Build.PRODUCT);
    }
