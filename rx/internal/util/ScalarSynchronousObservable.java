...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    ...
    class C19391 implements OnSubscribe<T> {
    ...
    public Observable<T> scalarScheduleOn(final Scheduler scheduler) {
        ...
        return create(new ScalarAsyncOnSubscribe(this.f241t, onSchedule));
    }

    public <R> Observable<R> scalarFlatMap(final Func1<? super T, ? extends Observable<? extends R>> func) {
        return create(new OnSubscribe<R>() {
            public void call(Subscriber<? super R> child) {
                Observable<? extends R> o = (Observable) func.call(ScalarSynchronousObservable.this.f241t);
                if (o instanceof ScalarSynchronousObservable) {
                    child.setProducer(ScalarSynchronousObservable.createProducer(child, ((ScalarSynchronousObservable) o).f241t));
                } else {
