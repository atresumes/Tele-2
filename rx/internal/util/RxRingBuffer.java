...
public class RxRingBuffer implements Subscription {
    ...
    public static ObjectPool<Queue<Object>> SPMC_POOL = new C19372();
    public static ObjectPool<Queue<Object>> SPSC_POOL = new C19361();
    static int _size;
    ...
    static class C19361 extends ObjectPool<Queue<Object>> {
        C19361() {
        }
    ...
    static class C19372 extends ObjectPool<Queue<Object>> {
        C19372() {
        }
