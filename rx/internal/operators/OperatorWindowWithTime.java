...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C19082 implements Action0 {
            C19082() {
            }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C19082(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C19091 implements Action0 {
            C19091() {
            }
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C19091(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
