...
public final class NotificationLite<T> {
    ...
    private static final Object ON_COMPLETED_SENTINEL = new C17631();
    private static final Object ON_NEXT_NULL_SENTINEL = new C17642();

    static class C17631 implements Serializable {
    ...
    static class C17642 implements Serializable {
    ...
    private static class OnErrorSentinel implements Serializable {
        ...
        public String toString() {
            return "Notification=>Error:" + this.f234e;
        }
    }
    ...
    public boolean accept(Observer<? super T> o, Object n) {
        if (n == ON_COMPLETED_SENTINEL) {
            ...
            o.onError(((OnErrorSentinel) n).f234e);
            return true;
        } else {
            o.onNext(n);
            return false;
    ...
    public Throwable getError(Object n) {
        return ((OnErrorSentinel) n).f234e;
    }
}
