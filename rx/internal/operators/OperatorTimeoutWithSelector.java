...
public class OperatorTimeoutWithSelector<T, U, V> extends OperatorTimeoutBase<T> {
    ...
    class C18921 implements FirstTimeoutStub<T> {
    ...
    class C18942 implements TimeoutStub<T> {
    ...
    public OperatorTimeoutWithSelector(Func0<? extends Observable<U>> firstTimeoutSelector, Func1<? super T, ? extends Observable<V>> timeoutSelector, Observable<? extends T> other) {
        super(new C18921(firstTimeoutSelector), new C18942(timeoutSelector), other, Schedulers.immediate());
    }
}
