...
public final class CompletableOnSubscribeTimeout implements CompletableOnSubscribe {
    ...
    public void call(final CompletableSubscriber s) {
        ...
        w.schedule(new Action0() {
            ...
            class C17601 implements CompletableSubscriber {
                C17601() {
                }
            ...
            public void call() {
                if (once.compareAndSet(false, true)) {
                    ...
                    if (CompletableOnSubscribeTimeout.this.other == null) {
                        ...
                        CompletableOnSubscribeTimeout.this.other.subscribe(new C17601());
                    }
                }
            }
        }, this.timeout, this.unit);
        this.source.subscribe(new CompletableSubscriber() {
            public void onSubscribe(Subscription d) {
                set.add(d);
            }
