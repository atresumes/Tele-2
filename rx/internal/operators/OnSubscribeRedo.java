...
public final class OnSubscribeRedo<T> implements OnSubscribe<T> {
    static final Func1<Observable<? extends Notification<?>>, Observable<?>> REDO_INFINITE = new C17731();
    ...
    static class C17731 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        class C17721 implements Func1<Notification<?>, Notification<?>> {
            C17721() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C17721());
        }
    }

    class C17773 implements Operator<Notification<?>, Notification<?>> {
        C17773() {
        }
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C17811 implements Func1<Notification<?>, Notification<?>> {
            int num = 0;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C17811()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C17821 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C17821() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C17821());
        }
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new Action0() {
            ...
            class C17741 extends Subscriber<T> {
                boolean done;
            ...
            public void call() {
                if (!subscriber.isUnsubscribed()) {
                    Subscriber<T> terminalDelegatingSubscriber = new C17741();
        ...
        final Observable<?> restarts = (Observable) this.controlHandlerFunction.call(terminals.lift(new C17773()));
