...
public final class OperatorTimeout<T> extends OperatorTimeoutBase<T> {
    ...
    class C18871 implements FirstTimeoutStub<T> {
        final /* synthetic */ TimeUnit val$timeUnit;
        final /* synthetic */ long val$timeout;

        C18871(long j, TimeUnit timeUnit) {
            this.val$timeout = j;
    ...
    class C18892 implements TimeoutStub<T> {
        final /* synthetic */ TimeUnit val$timeUnit;
        final /* synthetic */ long val$timeout;

        C18892(long j, TimeUnit timeUnit) {
            this.val$timeout = j;
            this.val$timeUnit = timeUnit;
        }
    ...
    public OperatorTimeout(long timeout, TimeUnit timeUnit, Observable<? extends T> other, Scheduler scheduler) {
        super(new C18871(timeout, timeUnit), new C18892(timeout, timeUnit), other, scheduler);
    }
}
