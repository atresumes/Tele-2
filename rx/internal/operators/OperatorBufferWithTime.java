...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C17971 implements Action0 {
            C17971() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C17971(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C17981 implements Action0 {
            C17981() {
            }
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C17981(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
