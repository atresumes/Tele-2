...
public class Completable {
    static final Completable COMPLETE = create(new C16821());
    static final RxJavaErrorHandler ERROR_HANDLER = RxJavaPlugins.getInstance().getErrorHandler();
    static final Completable NEVER = create(new C16902());
    ...
    static class C16821 implements CompletableOnSubscribe {
        C16821() {
        }
    ...
    static class C16902 implements CompletableOnSubscribe {
        C16902() {
        }
                ...
                try {
                    ...
                    try {
                        ...
                        cs.subscribe(new CompletableSubscriber() {
                            ...
                            class C16751 implements Action0 {
                                C16751() {
                                }
                            ...
                            public void onSubscribe(Subscription d) {
                                this.f232d = d;
                                s.onSubscribe(Subscriptions.create(new C16751()));
                            }
                        });
                    } catch (Throwable ex2) {
        ...
        return create(new CompletableOnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.subscribe(new CompletableSubscriber() {
                    ...
                    class C16771 implements Action0 {
                        C16771() {
                        }
                    ...
                    public void onCompleted() {
                        set.add(w.schedule(new C16771(), j, timeUnit));
                    }
        ...
        return create(new CompletableOnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.subscribe(new CompletableSubscriber() {
                    ...
                    class C16831 implements Action0 {
                        C16831() {
                        }
        ...
        return create(new CompletableOnSubscribe() {
            public void call(final CompletableSubscriber s) {
                ...
                Completable.this.subscribe(new CompletableSubscriber() {
                    ...
                    class C16871 implements CompletableSubscriber {
                        C16871() {
                        }
