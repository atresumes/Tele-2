...
public final class Cookie {
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        int pairEqualsSign = Util.delimiterOffset(setCookie, 0, cookiePairEnd, (char) SignatureVisitor.INSTANCEOF);
        ...
        while (pos < limit) {
            ...
            int attributeEqualsSign = Util.delimiterOffset(setCookie, pos, attributePairEnd, (char) SignatureVisitor.INSTANCEOF);
    ...
    private static int dateCharacterOffset(String input, int pos, int limit, boolean invert) {
        for (int i = pos; i < limit; i++) {
            ...
            if ((c >= 32 || c == 9) && c < 127 && ((c < 48 || c > 57) && ((c < 97 || c > Opcodes.ISHR) && ((c < 65 || c > 90) && c != 58)))) {
                dateCharacter = false;
            } else {
                dateCharacter = true;
            }
