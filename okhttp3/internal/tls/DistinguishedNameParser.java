...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        this.beg = this.pos;
        this.pos++;
        while (this.pos < this.length && this.chars[this.pos] != SignatureVisitor.INSTANCEOF && this.chars[this.pos] != ' ') {
            this.pos++;
        }
        if (this.pos >= this.length) {
        ...
        if (this.chars[this.pos] == ' ') {
            ...
            if (this.chars[this.pos] != SignatureVisitor.INSTANCEOF || this.pos == this.length) {
                throw new IllegalStateException("Unexpected end of DN: " + this.dn);
            }
        }
        this.pos++;
    ...
    private String hexAV() {
        ...
        this.beg = this.pos;
        this.pos++;
        while (this.pos != this.length && this.chars[this.pos] != SignatureVisitor.EXTENDS && this.chars[this.pos] != ',' && this.chars[this.pos] != ';') {
            if (this.chars[this.pos] == ' ') {
                this.end = this.pos;
                this.pos++;
                while (this.pos < this.length && this.chars[this.pos] == ' ') {
        ...
        while (this.pos < this.length) {
            ...
            switch (this.chars[this.pos]) {
                case ' ':
                    ...
                    if (this.pos != this.length && this.chars[this.pos] != ',' && this.chars[this.pos] != SignatureVisitor.EXTENDS && this.chars[this.pos] != ';') {
                        break;
                    }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        do {
            ...
            if (this.chars[this.pos] == ',' || this.chars[this.pos] == ';' || this.chars[this.pos] == SignatureVisitor.EXTENDS) {
                this.pos++;
                attType = nextAT();
            } else {
                throw new IllegalStateException("Malformed DN: " + this.dn);
