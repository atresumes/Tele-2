...
public class DoctorSearch extends BaseActivity {
    ...
    class C10862 implements AlertCallBackInterface {
        C10862() {
        }
    ...
    class C10873 implements OnPageChangeListener {
        C10873() {
        }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("WIdth", "" + CommonUtils.getWindowDimension(this, true));
        Log.e("HEIGHT", "" + CommonUtils.getWindowDimension(this, false));
    ...
    private void initViews() {
        ...
        if (BuildConfig.FLAVOR.equals("Health4Life")) {
            tabsStrip.setIndicatorHeight(0);
        } else {
            try {
        ...
        this.img_header_back.setOnClickListener(new C10851());
        ...
        if (SharedPreff.isFirstTimeDoctorSearch()) {
            ...
            if (!BuildConfig.FLAVOR.equals("Health4Life")) {
                DialogPopUps.confirmationPopUp(this, getResources().getString(C1020R.string.message), getResources().getString(C1020R.string.you_will_be_now_be_prompted_to_select_a_doctor), new C10862());
            }
        }
        viewPager.addOnPageChangeListener(new C10873());
    }
