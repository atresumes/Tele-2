...
public class StaffRightSideNavigation extends Adapter<ViewHolder> {
    Context context;
    TypedArray icons;
    File imageFile;
    private LoginDocResponce loginDocResponce = SharedPreff.getStaffLoginResponse();
    ...
    class C11251 implements OnClickListener {
        ...
        public void onClick(View v) {
            MainActivity mainActivity = StaffRightSideNavigation.this.context;
            MainActivity.drawerLayout.closeDrawers();
            FragmentTransaction fragmentTransaction = mainActivity.getSupportFragmentManager().beginTransaction();
            StaffEditProfile myProfile = new StaffEditProfile();
            Bundle bundle = new Bundle();
            bundle.putString("title", StaffRightSideNavigation.this.context.getResources().getString(C1020R.string.edit_profile));
        ...
        public void onClick(View v) {
            ...
            switch (getAdapterPosition()) {
                ...
                case 3:
                    ...
                    return;
                case 4:
                    fragmentTransaction.replace(C1020R.id.containerView, new StaffEditProfile());
                    fragmentTransaction.commit();
                    return;
                case 5:
    ...
    public StaffRightSideNavigation(String[] titles, TypedArray icons, Context context, File imageFile, MainActivityPresenter mainActivityPresenter) {
        this.titles = titles;
        this.icons = icons;
        this.context = context;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (position != 0) {
            ...
            holder.speciality.setText(this.loginDocResponce.getData().getDesignation());
            ...
            holder.img_edit.setOnClickListener(new C11251());
        }
    }
