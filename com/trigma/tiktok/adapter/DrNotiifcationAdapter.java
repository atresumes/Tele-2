...
public class DrNotiifcationAdapter extends Adapter<MyViewHolder> {
    ...
    public DrNotiifcationAdapter(NotificationPresenter notificationPresenter, Notification view) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Picasso.with(this.view.getActivity()).load(Constants.HTTP + notificationMainObject.getProfile()).transform(new CircleTransform()).placeholder((int) C1020R.drawable.profile_circle).error((int) C1020R.drawable.profile_circle).into(holder.img_user);
    }
