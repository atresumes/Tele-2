...
public class DoctorSearchAdapter extends Adapter<MyViewHolder> {
    ...
    public DoctorSearchAdapter(DoctorFragment view, DoctorFragmentPresenter doctorFragmentPresenter) {
        this.view = view;
        this.doctorFragmentPresenter = doctorFragmentPresenter;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Log.e(Scopes.PROFILE, "" + drSearchNameObject.getProfilePic());
        holder.tv_name.setText("Dr. " + drSearchNameObject.getName());
        ...
        Picasso.with(this.view.getActivity()).load(Constants.HTTP + drSearchNameObject.getProfilePic()).resize(100, 100).transform(new CircleTransform()).placeholder((int) C1020R.drawable.profile_circle).error((int) C1020R.drawable.profile_circle).into(holder.img_user);
        holder.card_view.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DoctorSearchAdapter.this.doctorFragmentPresenter.goToDetail(drSearchNameObject);
            }
        });
    }
