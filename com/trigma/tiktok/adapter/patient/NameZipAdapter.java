...
public class NameZipAdapter extends Adapter<MyViewHolder> {
    ...
    public NameZipAdapter(NameZipFragment view, NameZipPresenter nameZipPresenter) {
        this.view = view;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.card_view.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                NameZipAdapter.this.nameZipPresenter.goToDetail(drSearchNameObject);
            }
        });
    }
