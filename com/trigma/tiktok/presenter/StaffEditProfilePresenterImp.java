...
public class StaffEditProfilePresenterImp implements MyProfilePresenter {
    ...
    private StaffEditProfile view;
    String[] zip_code_length = new String[]{"5", "9"};

    class C12981 implements Observer<LoginDocResponce> {

        class C12971 implements AlertCallBackInterface {
            C12971() {
            }

            public void neutralClick() {
                StaffEditProfilePresenterImp.this.view.setData(StaffEditProfilePresenterImp.this.data);
            }
        }
        ...
        public void onError(Throwable e) {
            if (StaffEditProfilePresenterImp.this.view != null) {
                StaffEditProfilePresenterImp.this.view.hideDialog();
                StaffEditProfilePresenterImp.this.view.showError(StaffEditProfilePresenterImp.this.view.getResources().getString(C1020R.string.something_went_wrong));
            }
        }
        ...
        public void onNext(LoginDocResponce docUserDetailResponse) {
            if (docUserDetailResponse.getStatus().equalsIgnoreCase(Constants.STATUS_OK)) {
                ...
                dataa.setDrRequest(StaffEditProfilePresenterImp.this.loginDocResponce.getData().getDrRequest());
                docUserDetailResponse.setData(dataa);
                SharedPreff.saveStaffLoginResponse(docUserDetailResponse);
                DialogPopUps.confirmationPopUp(StaffEditProfilePresenterImp.this.view.getActivity(), "", StaffEditProfilePresenterImp.this.view.getResources().getString(C1020R.string.your_has_been_updated_successfully), new C12971());
                return;
            }
            StaffEditProfilePresenterImp.this.view.showError(docUserDetailResponse.getError());
        }
    }

    class C12992 implements Observer<DocUserDetailResponse> {
        C12992() {
        }
        ...
        public void onNext(DocUserDetailResponse docUserDetailResponse) {
            if (StaffEditProfilePresenterImp.this.view != null) {
                StaffEditProfilePresenterImp.this.view.hideDialog();
                if (docUserDetailResponse.getStatus().equalsIgnoreCase(Constants.STATUS_OK)) {
                    StaffEditProfilePresenterImp.this.view.setUserData(docUserDetailResponse.getData());
                } else {
                    StaffEditProfilePresenterImp.this.view.showError(docUserDetailResponse.getError());
                }
            }
    ...
    public StaffEditProfilePresenterImp(StaffEditProfile view, NetWorkingService netWorkingService) {
        this.view = view;
    ...
    public void doneButonFunctionality(String st_first_name, String st_last_name, String st_email, String st_designation, String st_country_code, String st_phone, DocUserDetail dataa) {
        ...
        this.data.setDesignation(st_designation);
        ...
        if (st_country_code.equalsIgnoreCase(this.view.getResources().getString(C1020R.string.ar_code))) {
        ...
        } else if (TextUtils.isEmpty(st_designation)) {
            this.view.showToastError(this.view.getResources().getString(C1020R.string.please_enter_designation));
            ...
            if (CommonUtils.isConnectedToInternet(this.view.getActivity())) {
                ...
                this.mSubscription = this.netWorkingService.getAPI().updateStaffProfile(st_first_name.toLowerCase(), st_last_name.toLowerCase(), st_phone, st_country_code, this.loginDocResponce.getData().get_id(), this.base64, st_designation).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new C12981());
                return;
            }
    ...
    public void doneButonFunctionality(String st_first_name, String st_last_name, String st_email, String st_address, String st_zip, String st_qualification, String st_speciality, String st_language, String st_bio, String st_country_code, String st_phone, DocUserDetail data) {
    }
    ...
    public void fetchDetail() {
        ...
        if (CommonUtils.isConnectedToInternet(this.view.getActivity())) {
            this.view.showProgressDialog();
            this.mSubscription = this.netWorkingService.getAPI().getDoctorProfile(this.loginDocResponce.getData().get_id()).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new C12992());
            return;
        }
        this.view.showError(this.view.getResources().getString(C1020R.string.check_your_network));
    }
