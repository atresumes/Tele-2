...
public class Past {
    ...
    private int CancellationUserType = 1;
    ...
    public int getCancellationUserType() {
        return this.CancellationUserType;
    }

    public void setCancellationUserType(int cancellationUserType) {
