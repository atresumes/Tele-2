...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C09101();
    ...
    static class C09101 implements Comparator<Comparable> {
        C09101() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09111 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09111() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09121 extends LinkedTreeMapIterator<K> {
            C09121() {
                super();
            }
