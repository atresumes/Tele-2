...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C09071();
    ...
    static class C09071 implements Comparator<Comparable> {
        C09071() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C09081 extends LinkedTreeMapIterator<Entry<K, V>> {
            C09081() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C09091 extends LinkedTreeMapIterator<K> {
            C09091() {
                super();
            }
