...
public class GoogleSignInAccount extends zza implements ReflectedParcelable {
    ...
    private static Comparator<Scope> zzajc = new C06541();
    ...
    class C06541 implements Comparator<Scope> {
        C06541() {
        }
    ...
    public static GoogleSignInAccount zzcu(@Nullable String str) throws JSONException {
        ...
        return zza(jSONObject.optString(ShareConstants.WEB_DIALOG_PARAM_ID), jSONObject.optString("tokenId", null), jSONObject.optString("email", null), jSONObject.optString("displayName", null), jSONObject.optString("givenName", null), jSONObject.optString("familyName", null), parse, Long.valueOf(parseLong), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzcv(jSONObject.optString("serverAuthCode", null));
    }
