...
class zzatl extends zzats {
    ...
    String zzfL(String str) {
        ...
        if (zzaue.zzcg(CommonUtils.MD5_INSTANCE) == null) {
            return null;
        }
        return String.format(Locale.US, "%032X", new Object[]{new BigInteger(1, zzaue.zzcg(CommonUtils.MD5_INSTANCE).digest(str2.getBytes()))});
    }
