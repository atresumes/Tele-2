...
public class zzuy {
    public static PendingIntent zza(Context context, AuthCredentialsOptions authCredentialsOptions, HintRequest hintRequest) {
        ...
        return PendingIntent.getActivity(context, CredentialsApi.CREDENTIAL_PICKER_REQUEST_CODE, zzuu.zza(context, hintRequest, zza(authCredentialsOptions)), 268435456);
    }
