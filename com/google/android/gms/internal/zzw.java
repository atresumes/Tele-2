    ...
    static HttpUriRequest zzb(zzk<?> com_google_android_gms_internal_zzk_, Map<String, String> map) throws zza {
        ...
        switch (com_google_android_gms_internal_zzk_.getMethod()) {
            case -1:
                ...
                httpPost2.addHeader(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzk_.zzi());
            ...
            case 1:
                ...
                httpPost.addHeader(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzk_.zzl());
