...
public class zzz implements zzy {
        ...
        switch (com_google_android_gms_internal_zzk_.getMethod()) {
            case -1:
                ...
                if (zzj != null) {
                    ...
                    httpURLConnection.addRequestProperty(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzk_.zzi());
    ...
    private static void zzb(HttpURLConnection httpURLConnection, zzk<?> com_google_android_gms_internal_zzk_) throws IOException, zza {
        ...
        if (zzm != null) {
            httpURLConnection.setDoOutput(true);
            httpURLConnection.addRequestProperty(HttpRequest.HEADER_CONTENT_TYPE, com_google_android_gms_internal_zzk_.zzl());
            DataOutputStream dataOutputStream = new DataOutputStream(httpURLConnection.getOutputStream());
