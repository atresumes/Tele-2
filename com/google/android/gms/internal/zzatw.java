...
public class zzatw extends zzats {
    ...
    class C07903 implements Runnable {
        ...
        C07903(zzatw com_google_android_gms_internal_zzatw) {
    ...
    class C07958 implements Runnable {
        final /* synthetic */ zzatw zzbuG;

        C07958(zzatw com_google_android_gms_internal_zzatw) {
            this.zzbuG = com_google_android_gms_internal_zzatw;
        }
    ...
    protected class zza implements ServiceConnection, zzb, zzc {
        ...
        class C08004 implements Runnable {
            final /* synthetic */ zza zzbuO;

            C08004(zza com_google_android_gms_internal_zzatw_zza) {
        ...
        public void onConnectionSuspended(int i) {
            ...
            this.zzbuG.zzJs().zzm(new C08004(this));
        }
        ...
        public void zzC(Intent intent) {
            ...
            synchronized (this) {
                ...
                this.zzbuL = true;
                zzyc.zza(context, intent, this.zzbuG.zzbuz, (int) Opcodes.LOR);
            }
        }
