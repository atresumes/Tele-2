...
public interface zzars extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzars {

        private static class zza implements zzars {
        ...
        public static zzars zzdj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.ISettingsCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzars)) ? new zza(iBinder) : (zzars) queryLocalInterface;
        }
