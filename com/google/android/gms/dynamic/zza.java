...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    private final zzf<T> zzaQg = new C06831(this);

    class C06831 implements zzf<T> {
        final /* synthetic */ zza zzaQh;

        C06831(zza com_google_android_gms_dynamic_zza) {
    ...
    class C06875 implements OnClickListener {
        final /* synthetic */ Intent zzaQm;
        final /* synthetic */ Context zztd;

        C06875(Context context, Intent intent) {
            this.zztd = context;
            this.zzaQm = intent;
        }
    ...
    class C06886 implements zza {
        final /* synthetic */ zza zzaQh;

        C06886(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    class C06897 implements zza {
        final /* synthetic */ zza zzaQh;

        C06897(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C06875(context, zzb));
        }
    }
