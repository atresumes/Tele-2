...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C06791 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaEu;

        C06791(ConnectionCallbacks connectionCallbacks) {
    ...
    class C06802 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaEv;

        C06802(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C06791(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C06802(onConnectionFailedListener);
    }
