...
public class EasyVideoPlayer extends FrameLayout implements IUserMethods, SurfaceTextureListener, OnPreparedListener, OnBufferingUpdateListener, OnCompletionListener, OnVideoSizeChangedListener, OnErrorListener, OnClickListener, OnSeekBarChangeListener {
    ...
    private final Runnable mUpdateCounters = new C04101();
    ...
    class C04123 extends AnimatorListenerAdapter {
        C04123() {
        }
    ...
    class C04145 implements OnClickListener {
        C04145() {
        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, C0415R.styleable.EasyVideoPlayer, 0, 0);
            try {
                String source = a.getString(C0415R.styleable.EasyVideoPlayer_evp_source);
                if (!(source == null || source.trim().isEmpty())) {
                    this.mSource = Uri.parse(source);
                }
                this.mLeftAction = a.getInteger(C0415R.styleable.EasyVideoPlayer_evp_leftAction, 1);
                this.mRightAction = a.getInteger(C0415R.styleable.EasyVideoPlayer_evp_rightAction, 3);
                this.mCustomLabelText = a.getText(C0415R.styleable.EasyVideoPlayer_evp_customLabelText);
                this.mRetryText = a.getText(C0415R.styleable.EasyVideoPlayer_evp_retryText);
                this.mSubmitText = a.getText(C0415R.styleable.EasyVideoPlayer_evp_submitText);
                this.mBottomLabelText = a.getText(C0415R.styleable.EasyVideoPlayer_evp_bottomText);
                int restartDrawableResId = a.getResourceId(C0415R.styleable.EasyVideoPlayer_evp_restartDrawable, -1);
                int playDrawableResId = a.getResourceId(C0415R.styleable.EasyVideoPlayer_evp_playDrawable, -1);
                int pauseDrawableResId = a.getResourceId(C0415R.styleable.EasyVideoPlayer_evp_pauseDrawable, -1);
                ...
                this.mHideControlsOnPlay = a.getBoolean(C0415R.styleable.EasyVideoPlayer_evp_hideControlsOnPlay, true);
                this.mAutoPlay = a.getBoolean(C0415R.styleable.EasyVideoPlayer_evp_autoPlay, false);
                this.mControlsDisabled = a.getBoolean(C0415R.styleable.EasyVideoPlayer_evp_disableControls, false);
                this.mThemeColor = a.getColor(C0415R.styleable.EasyVideoPlayer_evp_themeColor, Util.resolveColor(context, C0415R.attr.colorPrimary));
                this.mAutoFullscreen = a.getBoolean(C0415R.styleable.EasyVideoPlayer_evp_autoFullscreen, false);
                this.mLoop = a.getBoolean(C0415R.styleable.EasyVideoPlayer_evp_loop, false);
            } finally {
                a.recycle();
            }
        } else {
            ...
            this.mThemeColor = Util.resolveColor(context, C0415R.attr.colorPrimary);
            this.mAutoFullscreen = false;
            this.mLoop = false;
        }
        if (this.mRetryText == null) {
            this.mRetryText = context.getResources().getText(C0415R.string.evp_retry);
        }
        if (this.mSubmitText == null) {
            this.mSubmitText = context.getResources().getText(C0415R.string.evp_submit);
        }
        if (this.mRestartDrawable == null) {
            this.mRestartDrawable = AppCompatResources.getDrawable(context, C0415R.drawable.evp_action_restart);
        }
        if (this.mPlayDrawable == null) {
            this.mPlayDrawable = AppCompatResources.getDrawable(context, C0415R.drawable.evp_action_play);
        }
        if (this.mPauseDrawable == null) {
            this.mPauseDrawable = AppCompatResources.getDrawable(context, C0415R.drawable.evp_action_pause);
        }
    }
    ...
    public void showControls() {
        if (!this.mControlsDisabled && !isControlsShown() && this.mSeeker != null) {
            ...
            this.mControlsFrame.animate().alpha(1.0f).setInterpolator(new DecelerateInterpolator()).setListener(new C04112()).start();
        }
    }
    ...
    public void hideControls() {
        if (!this.mControlsDisabled && isControlsShown() && this.mSeeker != null) {
            ...
            this.mControlsFrame.setVisibility(0);
            this.mControlsFrame.animate().alpha(0.0f).setInterpolator(new DecelerateInterpolator()).setListener(new C04123()).start();
        }
    }
    ...
    public void enableControls(boolean andShow) {
        ...
        this.mClickFrame.setOnClickListener(new C04134());
    ...
    protected void onFinishInflate() {
        ...
        this.mProgressFrame = li.inflate(C0415R.layout.evp_include_progress, this, false);
        addView(this.mProgressFrame);
        this.mClickFrame = new FrameLayout(getContext());
        ((FrameLayout) this.mClickFrame).setForeground(Util.resolveDrawable(getContext(), C0415R.attr.selectableItemBackground));
        addView(this.mClickFrame, new ViewGroup.LayoutParams(-1, -1));
        this.mControlsFrame = li.inflate(C0415R.layout.evp_include_controls, this, false);
        ...
        if (this.mControlsDisabled) {
            ...
            this.mClickFrame.setOnClickListener(new C04145());
        }
        this.mSeeker = (SeekBar) this.mControlsFrame.findViewById(C0415R.id.seeker);
        this.mSeeker.setOnSeekBarChangeListener(this);
        this.mLabelPosition = (TextView) this.mControlsFrame.findViewById(C0415R.id.position);
        this.mLabelPosition.setText(Util.getDurationString(0, false));
        this.mLabelDuration = (TextView) this.mControlsFrame.findViewById(C0415R.id.duration);
        this.mLabelDuration.setText(Util.getDurationString(0, true));
        this.mBtnRestart = (ImageButton) this.mControlsFrame.findViewById(C0415R.id.btnRestart);
        this.mBtnRestart.setOnClickListener(this);
        this.mBtnRestart.setImageDrawable(this.mRestartDrawable);
        this.mBtnRetry = (TextView) this.mControlsFrame.findViewById(C0415R.id.btnRetry);
        this.mBtnRetry.setOnClickListener(this);
        this.mBtnRetry.setText(this.mRetryText);
        this.mBtnPlayPause = (ImageButton) this.mControlsFrame.findViewById(C0415R.id.btnPlayPause);
        this.mBtnPlayPause.setOnClickListener(this);
        this.mBtnPlayPause.setImageDrawable(this.mPlayDrawable);
        this.mBtnSubmit = (TextView) this.mControlsFrame.findViewById(C0415R.id.btnSubmit);
        this.mBtnSubmit.setOnClickListener(this);
        this.mBtnSubmit.setText(this.mSubmitText);
        this.mLabelCustom = (TextView) this.mControlsFrame.findViewById(C0415R.id.labelCustom);
        this.mLabelCustom.setText(this.mCustomLabelText);
        this.mLabelBottom = (TextView) this.mControlsFrame.findViewById(C0415R.id.labelBottom);
    ...
    public void onClick(View view) {
        if (view.getId() == C0415R.id.btnPlayPause) {
            ...
            start();
        } else if (view.getId() == C0415R.id.btnRestart) {
            seekTo(0);
            if (!isPlaying()) {
                start();
            }
        } else if (view.getId() == C0415R.id.btnRetry) {
            if (this.mCallback != null) {
                this.mCallback.onRetry(this, this.mSource);
            }
        } else if (view.getId() == C0415R.id.btnSubmit && this.mCallback != null) {
