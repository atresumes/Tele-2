...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C10052();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C10041();
    ...
    static class C10041 extends ThreadLocal<StringBuilder> {
        C10041() {
        }
    ...
    static class C10052 extends RequestHandler {
        C10052() {
        }
