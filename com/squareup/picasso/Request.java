...
public final class Request {
    ...
    String logId() {
        ...
        if (delta > TOO_LONG_LOG) {
            return plainId() + SignatureVisitor.EXTENDS + TimeUnit.NANOSECONDS.toSeconds(delta) + 's';
        }
        return plainId() + SignatureVisitor.EXTENDS + TimeUnit.NANOSECONDS.toMillis(delta) + "ms";
    }
