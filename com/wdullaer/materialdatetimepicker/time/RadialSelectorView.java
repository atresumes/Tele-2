...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, TimePickerController controller, boolean hasInnerCircle, boolean disappearsOut, int selectionDegrees, boolean isInnerCircle) {
        ...
        if (hasInnerCircle) {
            ...
            this.mOuterNumbersRadiusMultiplier = Float.parseFloat(res.getString(C1395R.string.mdtp_numbers_radius_multiplier_outer));
        } else {
            this.mNumbersRadiusMultiplier = Float.parseFloat(res.getString(C1395R.string.mdtp_numbers_radius_multiplier_normal));
        }
        this.mSelectionRadiusMultiplier = Float.parseFloat(res.getString(C1395R.string.mdtp_selection_radius_multiplier));
