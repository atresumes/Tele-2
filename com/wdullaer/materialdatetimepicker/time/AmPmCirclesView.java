...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, TimePickerController controller, int amOrPm) {
        ...
        if (controller.isThemeDark()) {
            this.mUnselectedColor = ContextCompat.getColor(context, C1395R.color.mdtp_circle_background_dark_theme);
            this.mAmPmTextColor = ContextCompat.getColor(context, C1395R.color.mdtp_white);
            this.mAmPmDisabledTextColor = ContextCompat.getColor(context, C1395R.color.mdtp_date_picker_text_disabled_dark_theme);
            this.mSelectedAlpha = 255;
        } else {
            this.mUnselectedColor = ContextCompat.getColor(context, C1395R.color.mdtp_white);
            this.mAmPmTextColor = ContextCompat.getColor(context, C1395R.color.mdtp_ampm_text_color);
            this.mAmPmDisabledTextColor = ContextCompat.getColor(context, C1395R.color.mdtp_date_picker_text_disabled);
            this.mSelectedAlpha = 255;
        }
        this.mSelectedColor = controller.getAccentColor();
        this.mTouchedColor = Utils.darkenColor(this.mSelectedColor);
        this.mAmPmSelectedTextColor = ContextCompat.getColor(context, C1395R.color.mdtp_white);
        this.mPaint.setTypeface(Typeface.create(res.getString(C1395R.string.mdtp_sans_serif), 0));
