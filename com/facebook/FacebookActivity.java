...
public class FacebookActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0502R.layout.com_facebook_activity_layout);
        ...
        if (fragment == null) {
            if (FacebookDialogFragment.TAG.equals(intent.getAction())) {
                ...
                manager.beginTransaction().add(C0502R.id.com_facebook_fragment_container, fragment, FRAGMENT_TAG).commit();
            }
        }
