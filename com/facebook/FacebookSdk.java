...
public final class FacebookSdk {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new C04881();
    ...
    static class C04881 implements ThreadFactory {
    ...
    static class C04892 implements Callable<Void> {
        C04892() {
        }
    ...
    public static synchronized void sdkInitialize(Context applicationContext) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                getExecutor().execute(new FutureTask(new C04892()));
