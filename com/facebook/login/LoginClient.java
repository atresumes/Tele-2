...
class LoginClient implements Parcelable {
    public static final Creator<LoginClient> CREATOR = new C05531();
    ...
    static class C05531 implements Creator {
        C05531() {
        }
    ...
    public static class Request implements Parcelable {
        public static final Creator<Request> CREATOR = new C05541();
        ...
        static class C05541 implements Creator {
            C05541() {
            }
    ...
    public static class Result implements Parcelable {
        public static final Creator<Result> CREATOR = new C05551();
        final Code code;
        ...
        static class C05551 implements Creator {
            C05551() {
            }
    ...
    boolean checkInternetPermission() {
        ...
        if (checkPermission("android.permission.INTERNET") != 0) {
            ...
            complete(Result.createErrorResult(this.pendingRequest, activity.getString(C0502R.string.com_facebook_internet_permission_error_title), activity.getString(C0502R.string.com_facebook_internet_permission_error_message)));
            return false;
        }
