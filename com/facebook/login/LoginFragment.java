...
public class LoginFragment extends Fragment {
    ...
    class C05561 implements OnCompletedListener {
        C05561() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.loginClient.setOnCompletedListener(new C05561());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(C0502R.layout.com_facebook_login_fragment, container, false);
        this.loginClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                view.findViewById(C0502R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                view.findViewById(C0502R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
            }
        });
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C0502R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
