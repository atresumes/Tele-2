...
public final class Profile implements Parcelable {
    public static final Creator<Profile> CREATOR = new C04992();
    ...
    static class C04981 implements GraphMeRequestWithCacheCallback {
        C04981() {
        }
    ...
    static class C04992 implements Creator {
        C04992() {
        }
    ...
    public static void fetchProfileForCurrentAccessToken() {
        ...
        if (accessToken == null) {
            ...
            Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(), new C04981());
        }
    }
