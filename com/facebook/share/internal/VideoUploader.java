...
public class VideoUploader {
    ...
    static class C06061 extends AccessTokenTracker {
        C06061() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C06101(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C06081();

        static class C06081 extends HashSet<Integer> {
            C06081() {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        static final Set<Integer> transientErrorCodes = new C06091();
        private String chunkEnd;
        private String chunkStart;

        static class C06091 extends HashSet<Integer> {
            C06091() {
    ...
    private static class UploadContext {
        ...
        private void initialize() throws java.io.FileNotFoundException {
            ...
            r4 = this;
            r1 = 0;
            r2 = r4.videoUri;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = com.facebook.internal.Utility.isFileUri(r2);	 Catch:{ FileNotFoundException -> 0x004c }
            if (r2 == 0) goto L_0x002b;
        L_0x0009:
            r2 = new java.io.File;	 Catch:{ FileNotFoundException -> 0x004c }
            r3 = r4.videoUri;	 Catch:{ FileNotFoundException -> 0x004c }
            r3 = r3.getPath();	 Catch:{ FileNotFoundException -> 0x004c }
            r2.<init>(r3);	 Catch:{ FileNotFoundException -> 0x004c }
            r3 = 268435456; // 0x10000000 float:2.5243549E-29 double:1.32624737E-315;
            r1 = android.os.ParcelFileDescriptor.open(r2, r3);	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = r1.getStatSize();	 Catch:{ FileNotFoundException -> 0x004c }
            r4.videoSize = r2;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = new android.os.ParcelFileDescriptor$AutoCloseInputStream;	 Catch:{ FileNotFoundException -> 0x004c }
            r2.<init>(r1);	 Catch:{ FileNotFoundException -> 0x004c }
            r4.videoStream = r2;	 Catch:{ FileNotFoundException -> 0x004c }
        L_0x0027:
            com.facebook.internal.Utility.closeQuietly(r1);
            return;
        L_0x002b:
            r2 = r4.videoUri;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = com.facebook.internal.Utility.isContentUri(r2);	 Catch:{ FileNotFoundException -> 0x004c }
            if (r2 == 0) goto L_0x0058;
        L_0x0033:
            r2 = r4.videoUri;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = com.facebook.internal.Utility.getContentSize(r2);	 Catch:{ FileNotFoundException -> 0x004c }
            r4.videoSize = r2;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = com.facebook.FacebookSdk.getApplicationContext();	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = r2.getContentResolver();	 Catch:{ FileNotFoundException -> 0x004c }
            r3 = r4.videoUri;	 Catch:{ FileNotFoundException -> 0x004c }
            r2 = r2.openInputStream(r3);	 Catch:{ FileNotFoundException -> 0x004c }
            r4.videoStream = r2;	 Catch:{ FileNotFoundException -> 0x004c }
            goto L_0x0027;
        L_0x004c:
            r0 = move-exception;
            r2 = r4.videoStream;	 Catch:{ all -> 0x0053 }
        ...
        L_0x0053:
            ...
            throw r2;
        L_0x0058:
            r2 = new com.facebook.FacebookException;	 Catch:{ FileNotFoundException -> 0x004c }
            r3 = "Uri must be a content:// or file:// uri";
            r2.<init>(r3);	 Catch:{ FileNotFoundException -> 0x004c }
            throw r2;	 Catch:{ FileNotFoundException -> 0x004c }
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.VideoUploader.UploadContext.initialize():void");
        }
    }
