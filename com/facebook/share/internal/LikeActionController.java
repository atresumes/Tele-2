...
public class LikeActionController {
    ...
    static class C05843 implements Callback {
        C05843() {
        }
    ...
    static class C05865 extends AccessTokenTracker {
        C05865() {
        }
    ...
    class C05929 implements RequestCompletionCallback {
        C05929() {
        }
    ...
    private abstract class AbstractRequestWrapper {
        ...
        class C05931 implements GraphRequest.Callback {
            C05931() {
            }
        ...
        protected void setRequest(GraphRequest request) {
            ...
            request.setCallback(new C05931());
        }
...
*/
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C05843());
                isInitialized = true;
            }
        }
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C05929());
        }
    }
