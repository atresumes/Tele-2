...
public final class AccessToken implements Parcelable {
    ...
    public static final Creator<AccessToken> CREATOR = new C04802();
    ...
    static class C04802 implements Creator {
        C04802() {
        }
    ...
    static AccessToken createFromJSONObject(JSONObject jsonObject) throws JSONException {
        ...
        return new AccessToken(token, jsonObject.getString(APPLICATION_ID_KEY), jsonObject.getString("user_id"), Utility.jsonArrayToStringList(permissionsArray), Utility.jsonArrayToStringList(declinedPermissionsArray), AccessTokenSource.valueOf(jsonObject.getString(SOURCE_KEY)), expiresAt, lastRefresh);
    }
