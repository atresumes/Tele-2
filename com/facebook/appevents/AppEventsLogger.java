...
public class AppEventsLogger {
    ...
    static class C05063 implements Runnable {
        C05063() {
        }
    ...
    static class C05074 implements Runnable {
        C05074() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        private static final Runnable appSessionInfoFlushRunnable = new C05111();
        private static Map<AccessTokenAppIdPair, FacebookTimeSpentData> appSessionInfoMap;
        private static boolean hasChanges = false;
        private static boolean isLoaded = false;
        private static final Object staticLock = new Object();

        static class C05111 implements Runnable {
            C05111() {
            }
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C05063(), 0, 15, TimeUnit.SECONDS);
            backgroundExecutor.scheduleAtFixedRate(new C05074(), 0, 86400, TimeUnit.SECONDS);
        }
    }
