...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C05261 implements OnCompleteListener {
        C05261() {
        }
    ...
    class C05272 implements OnCompleteListener {
        C05272() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C05272());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C05261()).build();
            }
