...
public final class EglCore {
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        if (EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
            ...
            if (this.mEGLContext == EGL14.EGL_NO_CONTEXT) {
                ...
                context = EGL14.eglCreateContext(this.mEGLDisplay, config, sharedContext, new int[]{12440, 2, 12344}, 0);
            ...
            log.m15d("EGLContext created, client version %d", Integer.valueOf(values[0]));
            return;
        }
    ...
    private EGLConfig getConfig(int flags, int version) {
        ...
        log.m23w("unable to find RGB8888 / %d EGLConfig", Integer.valueOf(version));
        return null;
    }
    ...
    protected void finalize() throws Throwable {
        try {
            if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
                log.m23w("WARNING: EglCore was not explicitly released -- state may be leaked", new Object[0]);
                release();
            }
            super.finalize();
        } catch (Throwable th) {
    ...
    public void makeCurrent(EGLSurface eglSurface) {
        if (this.mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            log.m23w("NOTE: makeCurrent w/o display", new Object[0]);
        }
    ...
    public static void logCurrent(String msg) {
        ...
        log.m23w("Current EGL (%s): display=%p, context=%p, surface=%p", msg, display, context, surface);
    }
