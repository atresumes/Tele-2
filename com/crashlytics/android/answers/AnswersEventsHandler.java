...
class AnswersEventsHandler implements EventsStorageListener {
    ...
    class C04222 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo3813e(Answers.TAG, "Failed to disable events", e);
            }
        }
    }
    ...
    class C04233 implements Runnable {
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo3813e(Answers.TAG, "Failed to send events files", e);
            }
        }
    }

    class C04244 implements Runnable {
        C04244() {
        }
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo3813e(Answers.TAG, "Failed to enable events", e);
            }
        }
    }

    class C04255 implements Runnable {
        C04255() {
        }
        ...
        public void run() {
            try {
                ...
                Fabric.getLogger().mo3813e(Answers.TAG, "Failed to flush events", e);
            }
        }
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo3813e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
    ...
    public void disable() {
        executeAsync(new C04222());
    }

    public void onRollOver(String rolledOverFile) {
        executeAsync(new C04233());
    }

    public void enable() {
        executeAsync(new C04244());
    }

    public void flushEvents() {
        executeAsync(new C04255());
    }
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo3813e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (sync) {
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo3813e(Answers.TAG, "Failed to run events task", e);
        }
    }
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo3813e(Answers.TAG, "Failed to submit events task", e);
        }
    }
}
