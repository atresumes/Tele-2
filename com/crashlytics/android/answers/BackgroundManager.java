...
class BackgroundManager {
    ...
    public void onActivityPaused() {
        if (this.flushOnBackground && !this.inBackground) {
            ...
            try {
                this.backgroundFutureRef.compareAndSet(null, this.executorService.schedule(new C04271(), 5000, TimeUnit.MILLISECONDS));
            } catch (RejectedExecutionException e) {
                Fabric.getLogger().mo3811d(Answers.TAG, "Failed to schedule background detector", e);
            }
        }
    }
}
