...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    private void setVerticalSlices() {
        ...
        float increment = TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES / ((float) this.mNumCols);
    ...
    private void setHorizontalSlices() {
        ...
        float increment = TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES / ((float) this.mNumRows);
        float percent = increment;
        ConstraintWidget previous = this;
