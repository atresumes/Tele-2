...
class CardViewGingerbread implements CardViewImpl {
    ...
    class C03281 implements RoundRectHelper {
        C03281() {
        }
        ...
        public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
            ...
            if (cornerRadius >= 1.0f) {
                ...
                canvas.drawArc(CardViewGingerbread.this.sCornerRect, BitmapDescriptorFactory.HUE_CYAN, 90.0f, true, paint);
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C03281();
    }
