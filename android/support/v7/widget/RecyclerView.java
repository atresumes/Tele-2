...
import android.support.v7.recyclerview.C0295R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C03533();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03571();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03582();
        private int mWidth;
        ...
        class C03582 implements Callback {
            C03582() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0295R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0295R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0295R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0295R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0295R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C03533 implements Interpolator {
        C03533() {
        }
    ...
    class C03544 implements ProcessCallback {
        C03544() {
        }
    ...
    class C03555 implements Callback {
        C03555() {
        }
    ...
    class C03566 implements Callback {
        C03566() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03591());
        Parcelable mLayoutState;

        static class C03591 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03591() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03511();
        ...
        this.mItemAnimatorRunner = new C03522();
        this.mViewInfoProcessCallback = new C03544();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0295R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0295R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0295R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03555());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03566());
    }
