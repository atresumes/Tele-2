...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C03381 implements OnAttachStateChangeListener {
        C03381() {
        }
    ...
    class C03392 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C03381());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C03392());
    }
