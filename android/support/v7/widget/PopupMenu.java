...
public class PopupMenu {
    ...
    class C03481 implements Callback {
        C03481() {
        }
    ...
    class C03492 implements android.widget.PopupWindow.OnDismissListener {
        C03492() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0293R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03481());
        ...
        this.mPopup.setOnDismissListener(new C03492());
    }
