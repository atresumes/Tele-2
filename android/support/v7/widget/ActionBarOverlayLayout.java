...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0293R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mRemoveActionBarHideOffset = new C03142();
        this.mAddActionBarHideOffset = new C03153();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0293R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0293R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0293R.id.action_bar));
        }
    }
