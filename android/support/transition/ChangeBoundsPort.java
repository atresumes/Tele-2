...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00801 extends TransitionListenerAdapter {
    ...
    class C00812 extends TransitionListenerAdapter {
        boolean mCanceled = false;
    ...
    class C00823 extends AnimatorListenerAdapter {
        C00823() {
        }
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C00812());
                    }
                    anim.addListener(new C00823());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
