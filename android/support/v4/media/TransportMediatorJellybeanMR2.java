...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01814();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01825();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01803();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01836();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01781();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01792();

    class C01781 implements OnWindowAttachListener {
        C01781() {
        }
    ...
    class C01792 implements OnWindowFocusChangeListener {
        C01792() {
        }
    ...
    class C01803 extends BroadcastReceiver {
        C01803() {
        }
    ...
    class C01814 implements OnAudioFocusChangeListener {
        C01814() {
        }
    ...
    class C01825 implements OnGetPlaybackPositionListener {
        C01825() {
        }
    ...
    class C01836 implements OnPlaybackPositionUpdateListener {
        C01836() {
        }
