...
public class MediaSessionCompat {
    ...
    class C01901 extends Callback {
        C01901() {
        }
    }

    class C01912 extends Callback {
        C01912() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01921();
        ...
        class C01932 implements Callback {
            C01932() {
            }
