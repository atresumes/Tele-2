...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02551());
        boolean isOpen;

        static class C02551 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02551() {
            }
