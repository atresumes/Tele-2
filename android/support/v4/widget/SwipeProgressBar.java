    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (!this.mRunning) {
                ...
                float clearRadius = ((float) (width / 2)) * INTERPOLATOR.getInterpolation((((float) ((now - this.mFinishTime) % 1000)) / 10.0f) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            ...
            if (rawProgress >= 0.0f && rawProgress <= 25.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor1, ((25.0f + rawProgress) * 2.0f) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            }
            if (rawProgress >= 0.0f && rawProgress <= 50.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor2, (2.0f * rawProgress) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            }
            if (rawProgress >= 25.0f && rawProgress <= 75.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor3, ((rawProgress - 25.0f) * 2.0f) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            }
            if (rawProgress >= 50.0f && rawProgress <= TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor4, ((rawProgress - 50.0f) * 2.0f) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            }
            if (rawProgress >= 75.0f && rawProgress <= TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor1, ((rawProgress - 75.0f) * 2.0f) / TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
            }
