...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01312();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01301();
    ...
    class C01312 implements OnItemClickListener {
        C01312() {
        }
