...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02261();
    ...
    private static final Interpolator sInterpolator = new C02272();
    ...
    private final Runnable mEndScrollRunnable = new C02283();
    ...
    static class C02261 implements Comparator<ItemInfo> {
        C02261() {
        }
    ...
    static class C02272 implements Interpolator {
        C02272() {
        }
    ...
    class C02283 implements Runnable {
        C02283() {
        }
    ...
    class C02294 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02294());
    }
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        if (velocity > 0) {
            ...
            duration = (int) ((1.0f + (((float) Math.abs(dx)) / (((float) this.mPageMargin) + (((float) width) * this.mAdapter.getPageWidth(this.mCurItem))))) * TrackerSettings.DEFAULT_MIN_METERS_BETWEEN_UPDATES);
        }
