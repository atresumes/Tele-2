...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01361();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01372();

    static class C01361 implements ThreadFactory {
    ...
    class C01372 extends WorkerRunnable<Params, Result> {
        C01372() {
        }
