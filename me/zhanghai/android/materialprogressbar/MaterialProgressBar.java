...
public class MaterialProgressBar extends ProgressBar {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        boolean z = false;
        TypedArray a = context.obtainStyledAttributes(attrs, C1532R.styleable.MaterialProgressBar, defStyleAttr, defStyleRes);
        this.mProgressStyle = a.getInt(C1532R.styleable.MaterialProgressBar_mpb_progressStyle, 0);
        boolean setBothDrawables = a.getBoolean(C1532R.styleable.MaterialProgressBar_mpb_setBothDrawables, false);
        boolean useIntrinsicPadding = a.getBoolean(C1532R.styleable.MaterialProgressBar_mpb_useIntrinsicPadding, true);
        int i = C1532R.styleable.MaterialProgressBar_mpb_showTrack;
        if (this.mProgressStyle == 1) {
            z = true;
        }
        boolean showTrack = a.getBoolean(i, z);
        if (a.hasValue(C1532R.styleable.MaterialProgressBar_android_tint)) {
            this.mProgressTint.mTintList = a.getColorStateList(C1532R.styleable.MaterialProgressBar_android_tint);
            this.mProgressTint.mHasTintList = true;
        }
        if (a.hasValue(C1532R.styleable.MaterialProgressBar_mpb_tintMode)) {
            this.mProgressTint.mTintMode = DrawableCompat.parseTintMode(a.getInt(C1532R.styleable.MaterialProgressBar_mpb_tintMode, -1), null);
