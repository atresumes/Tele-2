...
public class IndeterminateHorizontalProgressDrawable extends IndeterminateProgressDrawableBase implements ShowTrackDrawable {
    ...
    private static final RectF RECT_BOUND = new RectF(-180.0f, GroundOverlayOptions.NO_DIMENSION, BitmapDescriptorFactory.HUE_CYAN, 1.0f);
    private static final RectF RECT_PADDED_BOUND = new RectF(-180.0f, -5.0f, BitmapDescriptorFactory.HUE_CYAN, 5.0f);
    private static final RectF RECT_PROGRESS = new RectF(-144.0f, GroundOverlayOptions.NO_DIMENSION, 144.0f, 1.0f);
